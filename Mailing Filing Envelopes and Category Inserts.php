	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/supplies/06.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Mailing / Filing Envelopes and Category Inserts</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Mailing Filing Envelopes and Category Inserts.php'">More Info</button>
                        </div>
				</div>
			</div>			
		</div>
