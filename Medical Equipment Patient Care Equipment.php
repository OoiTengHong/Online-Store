	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/Medical Equipment Patient Care Equipment/01.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Bassinets</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Medical Equipment Patient Care Equipment.php'">More Info</button>
                        </div>
				</div>
			</div>
			<div class ="item col-md-3">
			<div class ="card">
				<div class="suibian-box">
						<div class="card-head">
							<img src="assets/img/Medical Equipment Patient Care Equipment/02.jpg" alt="img" class="card-img-top">
						</div>						
						<div class="card-body">
								
							<p class="text-center title">Cabinets</p>
