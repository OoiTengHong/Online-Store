	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/Film Viewing Equipment/01.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">High Volume Radiology Station and Systems</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Film VIEwing Equipment.php'">More Info</button>
                        </div>
				</div>
			</div>
			<div class ="item col-md-3">
			<div class ="card">
				<div class="suibian-box">
						<div class="card-head">
							<img src="assets/img/Film Viewing Equipment/02.jpg" alt="img" class="card-img-top">
						</div>						
						<div class="card-body">
								
							<p class="text-center title">Economy/Low Cost</p>
