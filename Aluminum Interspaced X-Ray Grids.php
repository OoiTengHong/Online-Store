	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/parts/01.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Aluminum Interspaced X-Ray Grids</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Aluminum Interspaced X-Ray Grids.php'">More Info</button>
                        </div>
				</div>
			</div>			
		</div>
