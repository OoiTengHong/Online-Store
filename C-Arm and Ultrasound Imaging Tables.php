	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/C-Arm and Ultrasound Imaging Tables/01.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">CR Systems</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='C-Arm and Ultrasound Imaging Tables.php'">More Info</button>
                        </div>
				</div>
			</div>
			<div class ="item col-md-3">
				...
				<div class="suibian-box">
						<div class="card-head">
							<img src="assets/img/C-Arm and Ultrasound Imaging Tables/02.jpg" alt="img" class="card-img-top">
						</div>						
						<div class="card-body">
								
							<p class="text-center title">DR Systems</p>
