	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/Exam Room Equipment/01.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Lighting</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Exam Room Equipment.php'">More Info</button>
                        </div>
				</div>
			</div>
			<div class ="item col-md-3">
			<div class ="card">
				<div class="suibian-box">
						<div class="card-head">
							<img src="assets/img/Exam Room Equipment/02.jpg" alt="img" class="card-img-top">
						</div>						
						<div class="card-body">
								
							<p class="text-center title">Instrument Stand/Solution Bowls ans Stands</p>
