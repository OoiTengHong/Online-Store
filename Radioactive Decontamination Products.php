	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/supplies/09.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Radioactive Decontamination Products</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Radioactive Decontamination Products.php'">More Info</button>
                        </div>
				</div>
			</div>			
		</div>
