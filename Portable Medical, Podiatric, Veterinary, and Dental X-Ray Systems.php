	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/Portable Medical, Podiatric, Veterinary, and Dental X-Ray Systems/01.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">JPI America</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Portable Medical, Podiatric, Veterinary, and Dental X-Ray Systems.php'">More Info</button>
                        </div>
				</div>
			</div>
			<div class ="item col-md-3">
			<div class ="card">
				<div class="suibian-box">
						<div class="card-head">
							<img src="assets/img/Portable Medical, Podiatric, Veterinary, and Dental X-Ray Systems/02.jpg" alt="img" class="card-img-top">
						</div>						
						<div class="card-body">
								
							<p class="text-center title">MinXray Portable X-Ray Medical Systems</p>
