	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/supplies/05.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Labels And Dispensers</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Labels And Dispensers.php'">More Info</button>
                        </div>
				</div>
			</div>			
		</div>
