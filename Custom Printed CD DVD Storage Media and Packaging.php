	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/supplies/03.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Custom Printed CD/DVD Storage Media and Packaging</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Custom Printed CD DVD Storage Media and Packaging.php'">More Info</button>
                        </div>
				</div>
			</div>			
		</div>
