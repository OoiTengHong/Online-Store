	...
	<div class="container">
        <div class="row">
             <div class="item col-md-3">
                <div class="card">
                        <div class="card-head">
                            <img src="assets/img/supplies/10.jpg" alt="img" class="card-img-top">
                        </div>
                        <div class="card-body">
                            
                            <p class="text-center title">Screen Cleaners and Surface Cleaners</p>
                            
                            <button class="btn btn-primary btn-sm eq-button" onclick="window.location.href='Screen Cleaners and Surface Cleaners.php'">More Info</button>
                        </div>
				</div>
			</div>			
		</div>
